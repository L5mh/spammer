...
def start_spam(phone):
    ...
    while True:
        try:
            formatted_phone = format_phone(str=phone, maska="+# (###) ###-##-##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = format_phone(str=phone[1:], maska="8(###)###-##-##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = format_phone(str=phone, maska="8(###)###-##-##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = format_phone(phone, maska="+# (###) ### - ## - ##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = format_phone(str=phone9, maska="8(###)###-##-##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = format_phone(str=phone9, maska="(###)###-##-##")
