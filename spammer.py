...
def main(s):
    ...
    if number == "1":
        ...
        if update == "y":
            ...
            banner()
            print("\033[1m\033[31m[!] Отменено\033[0m")
            main(1)
    elif number == "3":
        banner()
        ...
        banner()
        print("\033[1m\033[31m[!] Не правильный номер пункта.\033[0m")
        main(1)


def start_spam(phone):
    def formate(str, maska):
    ...
    while True:
        try:
            formatted_phone = formate(str=phone, maska="+# (###) ###-##-##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = formate(str=phone[1:], maska="8(###)###-##-##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = formate(str=phone, maska="8(###)###-##-##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = formate(phone, maska="+# (###) ### - ## - ##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = formate(str=phone9, maska="8(###)###-##-##")
        ...
        try:
            ...
            pass
        try:
            formatted_phone = formate(str=phone9, maska="(###)###-##-##")
